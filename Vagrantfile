...
echo "http://6.2.26.local.typo3.org/typo3/"
echo "http://7.6.10.local.typo3.org/typo3/"
echo "http://8.2.1.local.typo3.org/typo3/"
echo " "
echo "MailHog"
...
# 		'6.2.26.local.typo3.org',
# 		'7.6.10.local.typo3.org',
# 		'8.2.1.local.typo3.org'
# 		]

...
echo "http://6.2.25.local.typo3.org/typo3/"
echo "http://7.6.9.local.typo3.org/typo3/"
echo "http://8.2.0.local.typo3.org/typo3/"
echo " "
echo "MailHog"
...
# 		'6.2.25.local.typo3.org',
# 		'7.6.9.local.typo3.org',
# 		'8.2.0.local.typo3.org'
# 		]

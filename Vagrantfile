...
echo "http://6.2.21.local.typo3.org/typo3/"
echo "http://7.6.5.local.typo3.org/typo3/"
echo "http://8.0.1.local.typo3.org/typo3/"
echo " "
echo "MailHog"
...
# 		'6.2.21.local.typo3.org',
# 		'7.6.5.local.typo3.org',
# 		'8.0.1.local.typo3.org'
# 		]
